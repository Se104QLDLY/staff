...
export const Sidebar: React.FC<SidebarProps> = ({ className = '', onOpenPanel }) => {
  ...
  const sidebarItems: SidebarItem[] = [
    ...
    {
      icon: <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5" viewBox="0 0 20 20" fill="currentColor"><path d="M10 2a2 2 0 00-2 2v2a2 2 0 002 2h2a2 2 0 002-2V4a2 2 0 00-2-2h-2zm-6 8a2 2 0 012-2h12a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2v-6zm2 0v6h12v-6H6z" /></svg>,
      ...
      >
        <div className="p-4 relative">
          ...
          <div className="flex items-center justify-between mb-6">
            {!collapsed ? (
              <Link to="/agencies" className="flex items-center space-x-3">
                <img src="/logo.png" alt="Logo" className="h-8 w-auto drop-shadow-lg" />
                <span className="text-lg font-extrabold text-blue-800 tracking-wide drop-shadow">Staff</span>
              </Link>
            ) : (
              <Link to="/agencies" className="mx-auto">
                <img src="/logo.png" alt="Logo" className="h-8 w-auto drop-shadow-lg" />
              </Link>
            )}
