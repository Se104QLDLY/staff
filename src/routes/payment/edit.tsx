  ...
  useEffect(() => {
    const loadPaymentData = async () => {
      try {
        ...
        const payment = payments.find((p: any) => p.payment_id == id);
        if (payment) {
          setFormData({
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 mb-8">
            <div className="flex items-center gap-4">
              ...
              <div>
                <h1 className="text-4xl font-bold text-blue-800">Chỉnh Sửa Phiếu Thu</h1>
                <p className="text-blue-600 text-base mt-1">Cập nhật thông tin phiếu thu #{id}</p>
              </div>
            </div>
