      ...
      <div className="bg-white rounded-3xl shadow-xl p-8 border-2 border-blue-100">
        <div className="flex items-center justify-between mb-8">
          <div>
            ...
            <p className="text-gray-600">Cập nhật thông tin phiếu nhập {existingData.id}</p>
          </div>
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-cyan-50 rounded-2xl p-6 border-2 border-blue-100">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
              ...
              <div>
                ...
                />
                {errors.importDate && (
                  <span className="text-red-500 text-sm mt-1">{errors.importDate.message}</span>
                )}
              </div>
          ...
          <div className="bg-gradient-to-r from-green-50 to-emerald-50 rounded-2xl p-6 border-2 border-green-100">
            <div className="flex justify-between items-center mb-4">
              <h2 className="text-xl font-bold text-green-800">Danh sách sản phẩm</h2>
              <button
                type="button"
            ...
            <div className="space-y-4">
              {fields.map((field, index) => (
                <div key={field.id} className="bg-white p-4 rounded-lg border-2 border-green-200">
                  <div className="flex justify-between items-center mb-3">
                    <h3 className="font-semibold text-green-800">Sản phẩm {index + 1}</h3>
                    {fields.length > 1 && (
                      <button
                        type="button"
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full px-3 py-2 border border-green-300 rounded-lg focus:outline-none focus:ring-1 focus:ring-green-500 focus:border-green-500"
                      />
            ...
            <div className="mt-6 p-4 bg-green-100 rounded-lg">
              <div className="flex justify-between items-center">
                <span className="text-green-800 font-bold text-lg">Tổng cộng:</span>
