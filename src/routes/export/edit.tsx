...
const getStatusChip = (status: any) => {
    switch (status) {
        ...
        case 'confirmed': return <span className="flex items-center gap-1.5 text-xs font-semibold bg-blue-100 text-blue-700 px-2.5 py-1 rounded-full"><CheckCircle size={14}/>Đã xác nhận</span>;
        case 'delivered': return <span className="flex items-center gap-1.5 text-xs font-semibold bg-emerald-100 text-emerald-700 px-2.5 py-1 rounded-full"><CheckCircle size={14}/>Đã giao hàng</span>;
